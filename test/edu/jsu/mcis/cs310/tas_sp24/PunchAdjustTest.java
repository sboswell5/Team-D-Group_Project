...
public class PunchAdjustTest {
    ...
    // Added test
    @Test
    public void testAdjustPunchesShift3() {
        ...
        Punch p1 = punchDAO.find(317);
        Punch p2 = punchDAO.find(378);
        Punch p3 = punchDAO.find(534);
        ...
        assertEquals("#4382D92D CLOCK IN: THU 08/02/2018 07:33:20", p1.printOriginal());
        assertEquals("#4382D92D CLOCK IN: THU 08/02/2018 07:30:00 (Interval Round)", p1.printAdjusted());
        
        assertEquals("#4382D92D CLOCK OUT: THU 08/02/2018 16:42:22", p2.printOriginal());
        assertEquals("#4382D92D CLOCK OUT: THU 08/02/2018 16:45:00 (Interval Round)", p2.printAdjusted());
        
        assertEquals("#4382D92D CLOCK IN: MON 08/06/2018 07:00:05", p3.printOriginal());
        assertEquals("#4382D92D CLOCK IN: MON 08/06/2018 07:00:00 (None)", p3.printAdjusted());

    }
    
    // Added test
    @Test
    public void testAdjustExtra() {
        ...
        Punch p1 = punchDAO.find(2855); 
        Punch p2 = punchDAO.find(1523);
        Punch p3 = punchDAO.find(1138);
        
        Punch p4 = punchDAO.find(1086); 
        Punch p5 = punchDAO.find(775);
        ...
        assertEquals("#3282F212 CLOCK IN: TUE 08/28/2018 07:00:00", p1.printOriginal());
        assertEquals("#3282F212 CLOCK IN: TUE 08/28/2018 07:00:00 (None)", p1.printAdjusted());
        
        assertEquals("#45E5059F CLOCK OUT: WED 08/15/2018 16:32:28", p2.printOriginal());
        assertEquals("#45E5059F CLOCK OUT: WED 08/15/2018 16:30:00 (Interval Round)", p2.printAdjusted());
        
        assertEquals("#9E06A774 CLOCK OUT: SAT 08/11/2018 11:02:17", p3.printOriginal());
        assertEquals("#9E06A774 CLOCK OUT: SAT 08/11/2018 11:00:00 (Interval Round)", p3.printAdjusted());
        
        assertEquals("#4C459F1E CLOCK IN: SAT 08/11/2018 05:53:44", p4.printOriginal());
        assertEquals("#4C459F1E CLOCK IN: SAT 08/11/2018 06:00:00 (Interval Round)", p4.printAdjusted());
        
        assertEquals("#398B1563 CLOCK OUT: WED 08/08/2018 12:02:39", p5.printOriginal());
        assertEquals("#398B1563 CLOCK OUT: WED 08/08/2018 12:00:00 (Interval Round)", p5.printAdjusted());
